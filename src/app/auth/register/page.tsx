  ...
  return (
    <div className="min-h-screen bg-hero-gradient flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <Suspense fallback={<div className="glass-card rounded-3xl p-8 shadow-glass flex items-center justify-center"><Loader2 className="w-8 h-8 text-indigo-600 animate-spin" /></div>}>
          <RegisterForm />
        </Suspense>
      </div>
    </div>
